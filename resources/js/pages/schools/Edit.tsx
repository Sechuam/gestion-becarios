                ...
                <form onSubmit={submit} className="space-y-6 border rounded-xl bg-card border-border shadow-sm p-6" >
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="code" className="bg-background border-border text-foreground" value={data.code} onChange={e => setData('code', e.target.value)}  />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <div className="space-y-2">
                            ...
                            <Input id="contact_person" className="bg-background border-border text-foreground" value={data.contact_person} onChange={e => setData('contact_person', e.target.value)}  />
                        ...
                        <div className="space-y-2">
                            ...
                            <Input id="contact_email" type="email" className="bg-background border-border text-foreground" value={data.contact_email} onChange={e => setData('contact_email', e.target.value)}  />
