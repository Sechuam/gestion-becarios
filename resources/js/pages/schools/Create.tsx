        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-4 max-w-2xl mx-auto">
                <div className="mb-6">
                    ...
                    <p className="text-muted-foreground text-sm">Completa los datos para dar de alta una nueva institución.</p>
                </div>
                <form onSubmit={submit} className="space-y-4 bg-card p-6 rounded-lg border shadow-sm">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-1">
                            <Label htmlFor="contact_position">Cargo del Contacto (Opcional)</Label>
                    ...
                    <div className="flex items-center justify-end gap-3 pt-4">
                        ...
                        <Button type="submit" disabled={processing}>Guardar Centro</Button>
                    </div>
                </form>
            </div>
        </AppLayout>
