    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6 w-full bg-white dark:bg-slate-900">
                <div className="mb-6">
                    <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-100">Nuevo Centro Educativo</h1>
                ...
                <form onSubmit={submit} className="space-y-6">
                    {/* DATOS DEL CENTRO */}
                    <div className="space-y-6 pt-6 border border-slate-200 dark:border-slate-800 rounded-xl p-6 bg-white dark:bg-slate-900 shadow-sm">
                    ...
                    <div className="space-y-6 pt-6 border border-slate-200 dark:border-slate-800 rounded-xl p-6 bg-white dark:bg-slate-900 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="web" type="url" className="bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-700 text-slate-900 dark:text-slate-100" placeholder="https://..." value={data.web} onChange={e => setData('web', e.target.value)} />
                    ...
                    <div className="space-y-6 pt-6 border border-slate-200 dark:border-slate-800 rounded-xl p-6 bg-white dark:bg-slate-900 shadow-sm">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div className="space-y-2">
                                ...
                                <Input id="agreement_signed_at" type="date" value={data.agreement_signed_at} onChange={(e) => setData('agreement_signed_at', e.target.value)} />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="agreement_expires_at" type="date" value={data.agreement_expires_at} onChange={(e) => setData('agreement_expires_at', e.target.value)} />
                            ...
                            <div className="space-y-2">
                                ...
                                <Input id="agreement_slots" type="number" min={1} value={data.agreement_slots} onChange={(e) => setData('agreement_slots', e.target.value)} />
                            ...
                            <div className="space-y-2 lg:col-span-3 md:col-span-2">
                                ...
                                <Input id="agreement_file" type="file" accept="application/pdf" onChange={(e) => setData('agreement_file', e.target.files?.[0] || null)} />
