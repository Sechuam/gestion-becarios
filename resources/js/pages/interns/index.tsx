...
<div className="flex flex-col gap-6 p-6 bg-background text-foreground">
    ...
    <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-3 border rounded-xl bg-card border-border shadow-sm">
            ...
            <table className="min-w-[900px] w-full text-sm">
                <thead>
                    <tr className="border-b bg-muted border-b-border">
                        ...
                        <th className="px-4 py-4 text-left font-semibold text-foreground">DNI</th>
                        <th className="px-4 py-4 text-left font-semibold text-foreground">Centro Educativo</th>
                        <th className="px-4 py-4 text-left font-semibold text-foreground">Grado</th>
                            ...
                            <td className="px-4 py-4">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div className="flex flex-col">
                                        ...
                                        <span className="text-[10px] text-muted-foreground uppercase tracking-wider font-medium">{intern.user?.email}</span>
                                    </div>
                                </div>
                            </td>
                            <td className="px-4 py-4 text-muted-foreground font-mono text-xs italic">{intern.dni}</td>
                            <td className="px-4 py-4 text-muted-foreground">{intern.education_center?.name}</td>
