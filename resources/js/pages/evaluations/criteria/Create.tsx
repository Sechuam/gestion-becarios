                ...
                <div className="relative overflow-hidden rounded-[2rem] bg-gradient-to-r from-sidebar to-[#1f4f52] p-8 shadow-xl md:p-10">
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-2 max-w-2xl text-lg font-medium italic text-white/70">
                            Define una metrica reutilizable para valorar el desempeno del becario.
                        </p>
                    </div>
                </div>
                    ...
                    <div className="mb-12">
                        <div className="mb-8 flex items-center gap-4 border-b border-sidebar/10 pb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-500">Nombre, categoria y contexto del criterio.</p>
                            </div>
                        </div>
                    ...
                    <div className="mb-12">
                        <div className="mb-8 flex items-center gap-4 border-b border-sidebar/10 pb-4">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-500">Peso, nota maxima y orden dentro del formulario.</p>
                            </div>
                        </div>
                        ...
                        <div className="mt-8 flex items-center gap-4">
                            <div className="relative inline-flex h-12 cursor-pointer items-center rounded-2xl border border-sidebar/10 bg-slate-50 px-4 transition-all hover:bg-slate-100">
                                ...
                                />
                                <Label htmlFor="is_active" className="ml-3 cursor-pointer text-sm font-black uppercase tracking-widest text-sidebar">Activar criterio</Label>
                            </div>
                        </div>
                    </div>
