                ...
                <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-sidebar to-sidebar-accent p-5 shadow-lg md:p-6">
                    ...
                    <div className="relative">
                        ...
                        <p className="mt-1 max-w-2xl text-xs font-medium text-white/65 italic">
                            Ajustando la configuracion del criterio{' '}
                            {criterion.name}.
                        </p>
                    </div>
                </div>
                        ...
                        <div className="mb-5 flex items-center gap-4 border-b border-sidebar/10 pb-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-500">
                                    Actualiza el significado y contexto del
                                    criterio.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="h-10 rounded-xl border-sidebar/20 bg-card focus:ring-sidebar/20"
                                />
                                {errors.name && (
                    ...
                    <div className="mb-8">
                        <div className="mb-5 flex items-center gap-4 border-b border-sidebar/10 pb-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm font-medium text-slate-500">
                                    Gestiona peso, limite de nota y orden
                                    visual.
                                </p>
                            </div>
                        </div>
