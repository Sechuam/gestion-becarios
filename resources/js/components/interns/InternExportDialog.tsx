...
interface InternExportDialogProps {
    ...
    onSelectedColumnsChange: (
        columns: string[] | ((prev: string[]) => string[]),
    ) => void;
    onExport: () => void;
    disabled?: boolean;
}
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogTrigger asChild>
                <Button className="h-8 gap-2 rounded-lg bg-gradient-to-r from-sidebar to-sidebar-accent px-3 text-[10px] font-black tracking-widest text-white uppercase shadow-sm hover:opacity-95">
            ...
            <DialogContent className="max-w-xl">
                ...
                <DialogFooter>
                    ...
                    <Button
                        onClick={onExport}
                        disabled={selectedColumns.length === 0 || disabled}
                    >
                        Descargar Excel
                    </Button>
                </DialogFooter>
