...
export function TodayLogsSection({
    ...
    return (
        <Collapsible open={todayLogsOpen} onOpenChange={onTodayLogsOpenChange}>
            <div className="rounded-xl border border-slate-300 bg-slate-100 p-2.5 shadow-sm dark:border-slate-700 dark:bg-slate-800">
                <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <CollapsibleTrigger asChild>
                        <Button
                            ...
                            variant="outline"
                            size="sm"
                            className="h-8 rounded-full border-slate-300 bg-white px-3 text-[10px] font-black tracking-widest text-sidebar uppercase hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900"
                        >
